...
function AddExpense() {
    ...
    const handleAddExpense = async (e) => {
        ...
        try {
            ...
            swal("Error!", error.message || "Failed to add expense", "error");
        }
    };
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
            ...
            <div className="flex-1 p-4 md:p-8 w-full overflow-y-auto flex items-center justify-center">
                <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-4 md:p-8 my-6 md:my-0">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">Add Expense</h1>
                    ...
                    <form onSubmit={handleAddExpense} className="space-y-6">
                        ...
                        >
                            {loading ? <Spinner as="span" animation="border" size="sm" /> : "Add Expense"}
                        </button>
                    </form>
                </div>
            </div>
